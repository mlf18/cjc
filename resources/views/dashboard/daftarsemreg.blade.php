...
<br />
  ...
  {!! Form::open(['url'=>'pemakalahs','class'=>'form-horizontal','method'=>'post',"enctype"=>"multipart/form-data"]) !!}
    <div class="form-gorup">
      ...
      <div class="col-md-12">
        {!! Form::text('name', null, ['class'=>'form-control dis']) !!}
    ...
    <div class="form-gorup">
      ...
      {!! Form::label('kategori', 'Jenis Kepesertaan', ['class'=>'control-label']) !!} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
       {!! Form::radio('jenis','pemakalah', false); !!} Pemakalah
        {!! Form::radio('jenis','peserta', true); !!} Peserta Aktif
      </div>
    </div> <br />
    ...
    <div class="form-gorup">
      ...
      <div class="col-md-12">
        {!! Form::text('jabatan', null, ['class'=>'form-control dis']) !!}
    ...
    <div class="form-gorup">
      ...
      <div class="col-md-12">
        {!! Form::text('instansi', null, ['class'=>'form-control dis']) !!}
        {!! $errors->has('kategori')?$errors->first('kategori'):'' !!}
      </div>
    </div>
    <div class="form-gorup">
      ...
      <div class="col-md-12">
        {!! Form::text('alamat_instansi', null, ['class'=>'form-control dis']) !!}
        {!! $errors->has('kategori')?$errors->first('kategori'):'' !!}
      </div>
    </div><div class="form-gorup">
      {!! Form::label('telp', 'Telp/Faxs', ['class'=>'control-label col-md-12']) !!}
      <div class="col-md-12">
        {!! Form::text('telp', null, ['class'=>'form-control dis']) !!}
        {!! $errors->has('kategori')?$errors->first('kategori'):'' !!}
      </div>
    </div><div class="form-gorup">
      {!! Form::label('hp', 'No Hp', ['class'=>'control-label col-md-12']) !!}
      <div class="col-md-12">
        {!! Form::text('hp', null, ['class'=>'form-control dis']) !!}
        {!! $errors->has('kategori')?$errors->first('kategori'):'' !!}
      </div>
    </div>
    <div class="form-gorup">
      ...
      <div class="col-md-12">
        {!! Form::text('email', null, ['class'=>'form-control dis']) !!}
        {!! $errors->has('kategori')?$errors->first('kategori'):'' !!}
      </div>
    </div>
    <br />
    ...
    <h8>File Abstrak</h8>
        <input type="file" name="abstrak"> <br />
    </div>
    <div class="form-gorup">
      <center><div class="col-md-offset-2 col-md-10">
        <input type="submit" value="Submit" class="btn btn-primary dis" id="submit" style="margin-top: 14px;" disabled>
      </div></center>
    </div>
  {!! Form::close() !!}
</div>
